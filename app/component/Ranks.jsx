...
function Ranks({leaderboardData}) {
  ...
  >
    <div className="col-span-1 text-center">
      <span
        className={`inline-flex items-center justify-center w-8 h-8 rounded-lg font-bold ${
          entry.rank === 1
            ? "bg-gray-800 text-emerald-400 border border-emerald-500"
            : entry.rank === 2
            ? "bg-gray-800 text-blue-400 border border-blue-500"
            : entry.rank === 3
            ? "bg-gray-800 text-amber-400 border border-amber-500"
    ...
    <div className="col-span-2 text-center text-emerald-400 font-semibold">
      {entry.wpm}
    </div>
